...
class CuttingsStitchingConfig:
    ...
    font_stroke_width: int = 2  # stroke width (px) used to bolden the depth label text
    ...
    padding_horizontal: int = 80  # left/right border width in pixels
    padding_vertical: int = 80  # top/bottom border height in pixels
